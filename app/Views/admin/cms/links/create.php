    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/cms/links/store'); ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                placeholder="Contoh: Portal Alumni">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i id="icon-preview" class="bi bi-link-45deg"></i></span>
                                <input type="text"
                                    class="form-control <?= (isset(session('errors')['icon'])) ? 'is-invalid' : ''; ?>"
                                    id="icon" name="icon" value="<?= old('icon', 'bi-link-45deg'); ?>" required
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="2"
                                placeholder="Tampilkan keterangan singkat di bawah judul"><?= old('description'); ?></textarea>
                        </div>
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary px-4">Simpan Tautan</button>
                        </div>
                    </form>
                </div>
            </div>
