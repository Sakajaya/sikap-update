...
<head>
    <meta charset="UTF-8">
    <title>Dokumen Rencana Kokurikuler - 7 KAIH</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h3>7 KEGIATAN ANAK INDONESIA HEBAT (7 KAIH)</h3>
    ...
    <div class="section">
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td>Melalui 7 Kegiatan Anak Indonesia Hebat (7 KAIH)</td>
            </tr>
        </table>
    </div>
    ...
    <!-- 7 KAIH yang Dipilih -->
    <div class="section">
        <div class="section-title">C. KEGIATAN 7 KAIH YANG DIPILIH</div>
        <div class="kaih-box">
            <h4>7 Kegiatan Anak Indonesia Hebat (7 KAIH)</h4>
            <p>Program 7 KAIH adalah kegiatan pembiasaan yang bertujuan membentuk karakter anak Indonesia yang sehat, cerdas, dan berakhlak mulia melalui 7 kegiatan rutin harian.</p>
        </div>
        <?php 
                ...
                <?php foreach ($detail['items'] as $item): ?>
                    <li>
                        ...
                        <br><em style="color: #666; font-size: 0.9em;">
                            Dimensi: <?= esc($item['dimensi_profil']) ?>
                            <?php if (!empty($item['sub_dimensi'])): ?>
                                | Sub Dimensi: <?= esc($item['sub_dimensi']) ?>
                            <?php endif; ?>
                        </em>
                    </li>
                <?php endforeach; ?>
