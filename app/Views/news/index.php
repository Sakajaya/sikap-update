...
<head>
    ...
    <title><?= $title ?> - <?= $school['name'] ?? 'ESPATA' ?></title>
    ...
    <meta property="og:title" content="<?= $title ?> - <?= $school['name'] ?? 'ESPATA' ?>">
    ...
    <meta property="twitter:title" content="<?= $title ?> - <?= $school['name'] ?? 'ESPATA' ?>">
