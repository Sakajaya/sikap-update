<div class="position-sticky pt-3 sidebar-mini">
  <ul class="nav flex-column">
    ...
    $inPresensi  = url_is('admin/attendance*') || url_is('admin/teacher-attendance*');
    ...
    $inAkun      = url_is('admin/users*') || url_is('admin/role-permission*') || url_is('profile*') || url_is('admin/updater*');
    ?>
    ...
    <li class="nav-item">
      ...
      <div class="collapse <?= $inKurikulum ? 'show' : '' ?>" id="menuKurikulum">
        <ul class="nav flex-column ms-3">
          ...
          <li><a class="nav-link <?= url_is('admin/administrasi-guru/kktp*') ? 'active' : '' ?>" href="<?= base_url('admin/administrasi-guru/kktp') ?>">📋 <span class="label">KKTP</span></a></li>
          ...
          <li><a class="nav-link <?= url_is('admin/administrasi-guru/soal-ai*') ? 'active' : '' ?>" href="<?= base_url('admin/administrasi-guru/soal-ai') ?>">🤖 <span class="label">Generate Soal AI</span></a></li>
        </ul>
      </div>
    </li>
    ...
    <!-- Presensi -->
    <li class="nav-item">
      <a class="nav-link d-flex align-items-center" data-bs-toggle="collapse" href="#menuPresensi"
        role="button" aria-expanded="<?= $inPresensi ? 'true' : 'false' ?>">
        🕒 <span class="label">Presensi/Absensi</span>
        <i class="bi bi-chevron-down chevron label ms-auto"></i>
      </a>
      <div class="collapse <?= $inPresensi ? 'show' : '' ?>" id="menuPresensi">
        <ul class="nav flex-column ms-3">
          <li><a class="nav-link <?= url_is('admin/attendance*') ? 'active' : '' ?>" href="<?= base_url('admin/attendance') ?>">🎓 <span class="label">Absensi Siswa</span></a></li>
          <?php if (is_school_swasta()): ?>
          <li><a class="nav-link <?= url_is('admin/teacher-attendance*') ? 'active' : '' ?>" href="<?= base_url('admin/teacher-attendance') ?>">👨‍🏫 <span class="label">Absensi Guru</span></a></li>
          <?php endif; ?>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse <?= $inNilai ? 'show' : '' ?>" id="menuNilai">
        <ul class="nav flex-column ms-3">
          <li><a class="nav-link <?= url_is('admin/assessments*') ? 'active' : '' ?>" href="<?= base_url('admin/assessments') ?>">📝 <span class="label">Input Nilai</span></a></li>
    ...
    <li class="nav-item">
      <a class="nav-link <?= url_is('admin/ebook*') ? 'active' : '' ?>" href="<?= base_url('admin/ebook') ?>">
    ...
    <!-- ══ LMS ══ -->
    <li class="nav-item mt-2">
      <small class="text-uppercase text-muted px-3 label" style="font-size:.68rem;letter-spacing:.08em;">Learning</small>
    </li>

    <!-- Learning — semua fitur pembelajaran dalam satu grup -->
    <li class="nav-item">
      <a class="nav-link d-flex align-items-center" data-bs-toggle="collapse" href="#menuLearning"
        role="button" aria-expanded="<?= $inLearning ? 'true' : 'false' ?>">
        <i class="bi bi-mortarboard"></i> <span class="label">Learning</span>
        <i class="bi bi-chevron-down chevron label ms-auto"></i>
      </a>
      <div class="collapse <?= $inLearning ? 'show' : '' ?>" id="menuLearning">
        <ul class="nav flex-column ms-3">
          <li><a class="nav-link <?= url_is('admin/materials*') ? 'active' : '' ?>" href="<?= base_url('admin/materials') ?>"><i class="bi bi-book me-1"></i> <span class="label">Materi Pelajaran</span></a></li>
          <li><a class="nav-link <?= url_is('admin/tugas*') ? 'active' : '' ?>" href="<?= base_url('admin/tugas') ?>"><i class="bi bi-pencil me-1"></i> <span class="label">Kirim Tugas</span></a></li>
          <li><a class="nav-link <?= url_is('admin/quiz*') ? 'active' : '' ?>" href="<?= base_url('admin/quiz') ?>"><i class="bi bi-pencil-square me-1"></i> <span class="label">Kuis Mandiri</span></a></li>
          <li><a class="nav-link <?= url_is('learning*') ? 'active' : '' ?>" href="<?= base_url('learning/class') ?>"><i class="bi bi-graph-up me-1"></i> <span class="label">Analitik Pembelajaran</span></a></li>
          <li><a class="nav-link <?= url_is('kalender*') ? 'active' : '' ?>" href="<?= base_url('kalender') ?>"><i class="bi bi-calendar3 me-1"></i> <span class="label">Kalender Akademik</span></a></li>
        </ul>
      </div>
    </li>
        ...
        <ul class="nav flex-column ms-3">
          ...
          <li>
            <a class="nav-link d-flex align-items-center <?= url_is('admin/staff-chat*') ? 'active' : '' ?>"
               ...
               onclick="if(window.location.href.includes('staff-chat')){event.preventDefault();window.location.reload();}">
      ...
      <div class="collapse <?= $inCms ? 'show' : '' ?>" id="menuCms">
        <ul class="nav flex-column ms-3">
          ...
          <?php if ($_SERVER['HTTP_HOST'] === 'localhost'): ?>
            <li><a class="nav-link <?= url_is('admin/changelogs*') ? 'active' : '' ?>" href="<?= base_url('admin/changelogs') ?>">📜 <span class="label">Developer Changelog</span></a></li>
          <?php endif; ?>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse <?= $inAkun ? 'show' : '' ?>" id="menuAkun">
        <ul class="nav flex-column ms-3">
          ...
          <li><a class="nav-link <?= url_is('admin/role-permission*') ? 'active' : '' ?>" href="<?= base_url('admin/role-permission') ?>">🛡️ <span class="label">Role & Permission</span></a></li>
          <li><a class="nav-link <?= url_is('profile*') ? 'active' : '' ?>" href="<?= base_url('profile') ?>">⚙️ <span class="label">Pengaturan Profil</span></a></li>
          <li><a class="nav-link <?= url_is('admin/settings/session*') ? 'active' : '' ?>" href="<?= base_url('admin/settings/session') ?>">🚀 <span class="label">Cache CBT</span></a></li>
          <?php if (is_school_swasta()): ?>
          <li><a class="nav-link <?= url_is('admin/settings/payment*') ? 'active' : '' ?>" href="<?= base_url('admin/settings/payment') ?>">💳 <span class="label">Integrasi Pembayaran</span></a></li>
          <?php endif; ?>
          <li><a class="nav-link <?= url_is('admin/updater*') ? 'active' : '' ?>" href="<?= base_url('admin/updater') ?>">🔄 <span class="label">Update Sistem</span></a></li>
        </ul>
      </div>
    </li>
